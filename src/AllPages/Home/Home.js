...
import myImg from '../../images/dp.jpg';
import './Home.css';
      ...
      <Container>
        ...
        <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={500} distance="30px">
          ...
          <Typical
            ...
            steps={['Front End Developer', 3500, 'Competitive Programmer', 3500, 'Engineering Student', 3500]}
            loop={Infinity}
            wrapper="p"
          />
        </Fade>
        ...
        <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={1000} distance="30px">
          <p className="hero-cta">
            <a
              ...
              href="https://drive.google.com/file/d/11h-API1vF-tX60HERoc9NYzWr2etnV0p/view?usp=sharing"
            >
              {cta}
            </a>
          </p>
